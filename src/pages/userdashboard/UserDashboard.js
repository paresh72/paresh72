...
export default function UserDashboards(props) {
  ...
  const handleChoice = (choice, operation) => {
    switch (choice) {
      case "dashboard":
        setRenderDashboard(<UserDashboard />);
        break;
      case "user":
        if (operation === "manage") {
          ...
          <div className="accordion mt-5">
            ...
            <div className="accordion-item" >
              <h6 className="accordion-header">
                ...
                >
                  <FaWpforms className="me-2 fs-5" /> Test result
                </button>
              </h6>
              <div className="accordion-collapse collapse" id="panelZero">
                <div className="accordion-body p-0 bg-lblue">
                  ...
                  >
                    <FaFileInvoice className="me-2 fs-5" /> Result
                  </button>
                </div>
              </div>
            </div>
